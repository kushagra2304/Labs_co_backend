...
exports.runFileAutoDeleteCheck = runFileAutoDeleteCheck;
const project_files_repository_1 = require("../project_files/project_files.repository");
const project_file_storage_service_1 = require("../project_files/project-file-storage.service");
const repo = new project_files_repository_1.ProjectFilesRepository();
const storage = new project_file_storage_service_1.ProjectFileStorageService();
/**
 ...
 */
async function runFileAutoDeleteCheck() {
    try {
